...
| [akka-runtime.md](akka-runtime.md) | How `Sagant.Runtime.Akka` actually runs a workflow: `WorkflowEntityActor`, persistence, timeouts, retries, tracing, `Akka.Delivery`, idempotency, graceful shutdown. |
